...
description: >-
  ...
  create a new skill (or update an existing skill) that extends Copilot's capabilities
  with specialized knowledge, workflows, or tool integrations.
  Triggers: create skill, new skill, update skill, write skill, skill template, extend
  copilot.
---
